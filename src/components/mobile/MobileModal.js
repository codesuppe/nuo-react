...
const MobileModal = ({ index, isOpen, onClose, modaldata }) => {
  //Formvalidation
  ...
  useEffect(() => {
    if (isOpen) {
      document.querySelector(".modalMobile").scrollIntoView({
        behavior: "smooth",
        block: "nearest",
        inline: "nearest",
      });
  ...
  return ReactDOM.createPortal(
    <div className="modalMobile">
      ...
      <form className="modalFormMobile" onSubmit={handleSubmit(onSubmit)}>
        <div>
          <h1>
